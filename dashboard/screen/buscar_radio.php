...
if(isset($_GET['empresa_id'])) {
    ...
    $sql = "SELECT * FROM radios WHERE empresa = $empresa_id";
    ...
    if ($result) {
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<div class="empsview">';
                echo '<div class="ip_form_sub_sep">';
                echo '<h4>' . $row['radio_nome'] . '</h4>';
                echo '<p>' . $row['ip'] . '</p>';
                ...
                echo '</div>';
                echo '<div class="radiosconfig">';
                echo '<a class="info-rads" target="_blank"><i class="fas fa-chart-bar"></i></a>';
            ...
            echo 'Nenhum radio encontrado para esta empresa.';
        }
    } else {
